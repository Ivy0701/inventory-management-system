  ...
  // 仓库管理员路由
  {
    ...
    children: [
      ...
      },
      {
        ...
        name: 'WarehouseInventoryStats',
        component: () => import('../views/InventoryStatsView.vue')
      },
      {
        path: 'regional-inventory',
        name: 'WarehouseRegionalInventory',
        component: () => import('../views/RegionalInventoryView.vue')
      },
      {
        path: 'replenishment',
        name: 'WarehouseReplenishment',
